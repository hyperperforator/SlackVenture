...
SlackVenture.prototype._firstRunCheck = function () {
    ...
    console.log("Team ID: " + self.team.id);
    ...
    self.db.get('SELECT val FROM info WHERE name = "lastrun" LIMIT 1', function (err, record) {
        ...
        if (!record) {
            ...
            //Store the team ID to help track the story later, as well as the first state
            self.db.run('INSERT INTO team(team, story_step) VALUES("' + teamID + '", 0)');
